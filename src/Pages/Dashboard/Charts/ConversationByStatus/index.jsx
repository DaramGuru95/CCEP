...
const ConversationByStatus = ({ data }) => (
  <ResponsiveLine
    data={data}
    theme={{
      grid: {
    ...
    colors={["hsla(178, 61%, 44%, 1)", "hsla(38, 100%, 50%, 1)","hsla(284, 63%, 51%, 1)"]}
    ...
    legends={[
        {
          ...
          // Customize the rendering of the legend symbol
        }
      ]}
...
export default ConversationByStatus;
